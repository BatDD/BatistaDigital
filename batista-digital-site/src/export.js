...
Observações:
  ...
  • A navegação usa URLs limpas (/about, /blog, /admin) via History API —
    hospede a pasta na raiz do domínio (ex.: https://meudominio.com/) e
    configure o servidor para servir index.html em qualquer rota
    (SPA fallback), ex.: Netlify _redirects, Vercel rewrites.
